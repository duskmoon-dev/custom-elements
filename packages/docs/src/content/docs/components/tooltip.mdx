...
import RegisterElement from '../../../components/RegisterElement.astro';

<RegisterElement element="@duskmoon-dev/el-tooltip" />
<RegisterElement element="@duskmoon-dev/el-button" />
